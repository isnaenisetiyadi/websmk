<template>
  <v-layout row>
    <v-flex
      ...
      :key="index"
    >
      <v-divider inset class="d-flex d-sm-none"></v-divider>
      <v-divider class="d-none d-sm-flex"></v-divider>
      <v-list-item route :to="'/berita/' + berita.berita.slug">
        <v-list-item-avatar class="d-flex d-sm-none">
        ...
        <v-list-item-content>
          ...
          <v-list-item-subtitle  class="d-flex d-sm-none font-weight-thin caption" v-html="berita.berita.deskripsi"></v-list-item-subtitle>
