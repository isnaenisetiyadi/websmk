      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            <h3>Student of November 2020</h3>
            <div class="row mb-5" data-aos="fade-left" data-aos-delay="100" >
              <div class="col-md-12">
                <figure>
                  <img src="img/img_1.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid" />
                  <figcaption>This is an image caption</figcaption>
                </figure>
              </div>
             
            </div>
            <p class="lead mb-5" data-aos="fade-down" data-aos-delay="100" >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda nihil aspernatur nemo sunt, qui, harum repudiandae quisquam eaque dolore itaque quod tenetur quo quos labore?</p>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae expedita cumque necessitatibus ducimus debitis totam, quasi praesentium eveniet tempore possimus illo esse, facilis? Corrupti possimus quae ipsa pariatur cumque, accusantium tenetur voluptatibus incidunt reprehenderit, quidem repellat
              sapiente, id, earum obcaecati.
            </p>
            ...
            <p>
              In adipisci corporis at delectus! Cupiditate, voluptas, in architecto odit id error reprehenderit quam quibusdam excepturi distinctio dicta laborum deserunt qui labore dignissimos necessitatibus reiciendis tenetur corporis quas explicabo exercitationem suscipit. Nisi quo nulla, nihil harum obcaecati vel
              atque quos.
            </p>
            ...
            <div class="pt-5">
              <p>Kategori : <a href="#">Design</a>, <a href="#">Events</a> Tags: <a href="#">#html</a>, <a href="#">#trends</a></p>
            </div>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box" data-aos="fade-up" data-aos-delay="300" >
              <div class="categories">
                <h3>Kategori</h3>
                <li>
                  <a href="#">Pengumuman <span>(12)</span></a>
                </li>
                <li>
                  <a href="#">Berita <span>(22)</span></a>
                </li>
                <li>
                  <a href="#">Prestasi <span>(37)</span></a>
                </li>
                <li>
                  <a href="#">Serba-serbi<span>(42)</span></a>
                </li>
              </div>
            </div>
            <div class="sidebar-box">
      ...
      <div class="row">
        <div class="col-md-4" data-aos="fade-up" data-aos-delay>
          <div class="feature-1 text-center">
            ...
            <p style="text-decoration: none">Cocok untuk kantor/ instansi/ sekolah, perusahan swasta, BUMN, dan lain-lain</p>
          </div>
        </div>
        ...
        <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
          <div class="feature-1 text-center">
            ...
            <p>Layanan pembuatan video promosi, animasi, sampai publikasi ke media sosial</p>
          </div>
        </div>
        <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
          <div class="feature-1 text-center">
